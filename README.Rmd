...
This document gives an illustration.  If you get bored, skip to the section titled "Interpreting the features with ggplot" and find the data analysis, where we analyze the popular `nycflights13` data with PCA.
